  ...
  <main>
    <section class="hero" id="inicio">
      <div class="container hero-content">
        ...
        <h2>Un rincón para quienes crecieron entre consolas, arcade y juegos inolvidables.</h2>
        <p class="hero-text">
      ...
      <div class="container">
        ...
        <div class="cards-grid">
          <article class="card">
            ...
            <p>El clásico que marcó generaciones y convirtió cada nivel en una aventura inolvidable.</p>
          </article>

          <article class="card">
            <h3>Contra</h3>
            <p>Acción intensa, cooperación y dificultad legendaria en uno de los juegos más recordados.</p>
          </article>

          <article class="card">
            <h3>Street Fighter II</h3>
            <p>El rey de las peleas arcade, responsable de tardes enteras frente a la máquina.</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <div class="posts-grid">
      <article class="post-card">
        ...
        <p class="post-excerpt">
          ...
          en uno de los clásicos más exigentes y recordados de la era arcade.
        </p>
      ...
      <article class="post-card">
        ...
        <p class="post-excerpt">
          Cómo un juego aparentemente simple cambió para siempre la historia de los
          videojuegos y se convirtió en símbolo de toda una generación.
        </p>
