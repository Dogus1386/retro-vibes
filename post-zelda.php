...
<head>
  ...
  <style>
    ...
    .like-form { margin:0; }
    .like-btn { background:linear-gradient(135deg,#1e293b,#334155); color:#fff; border:1px solid #475569; padding:8px 14px; border-radius:10px; cursor:pointer; font-weight:700; transition:.25s ease; }
    .like-btn:hover { transform:translateY(-1px); box-shadow:0 0 12px rgba(255,255,255,.12); }
    .like-btn.liked { background:linear-gradient(135deg,#e11d48,#fb7185); border-color:#fb7185; }
    .like-count { color:#facc15; font-weight:700; font-size:14px; }
    .like-login-msg { color:#94a3b8; font-size:14px; }
    #contador { margin-top:8px; font-size:14px; color:#94a3b8; }
  </style>
</head>
<body>
<header class="site-header">
  <div class="container header-content">
    <div class="logo"><span class="logo-icon">🕹️</span><h1>Retro Vibes</h1></div>
    <nav class="main-nav">
  ...
  <section class="post-hero">
    <div class="container post-hero-content">
      <nav class="breadcrumb">
        <a href="index.php">Inicio</a><span>/</span><a href="blog.php">Blog</a><span>/</span><span class="breadcrumb-current">Zelda</span>
      </nav>
      <span class="post-category">Adventure</span>
      <div class="post-meta"><span>Nintendo</span><span>•</span><span>1986</span><span>•</span><span>5 min de lectura</span></div>
      <h2 class="post-title">The Legend of Zelda y la aventura eterna</h2>
      <p class="post-intro">Zelda abrió la puerta a un tipo de aventura que se sentía enorme, misteriosa y llena de secretos. Fue un clásico que enseñó a explorar sin miedo.</p>
    </div>
  </section>
  ...
  <section class="post-content-section">
    <div class="container post-layout">
      <article class="post-content">
        <div class="post-image"><img src="assets/img/zelda1.jpg" alt="The Legend of Zelda clásico retro"></div>

        <p>El primer The Legend of Zelda fue especial porque no se limitó a llevar al jugador de un punto a otro. Lo soltaba en un mundo abierto para la época y lo invitaba a descubrir por sí mismo qué hacer, a dónde ir y qué peligros enfrentar.</p>
        <p>Esa sensación de aventura real fue parte de su magia. No era un juego que lo explicaba todo. Te obligaba a observar, probar, equivocarte y volver a intentarlo, y eso lo hacía memorable.</p>

        <h3>Exploración, secretos y libertad</h3>
        <p>Zelda destacó por su estructura abierta. Había cuevas escondidas, caminos secretos, enemigos peligrosos y objetos que cambiaban la forma de jugar. Cada descubrimiento se sentía importante.</p>
        <p>El jugador no solo avanzaba: investigaba, recordaba lugares y construía su propio mapa mental del reino. Eso fue revolucionario y ayudó a definir el género de aventura.</p>

        <div class="retro-note">
          <h4>Dato retro</h4>
          <p>El juego se lanzó originalmente para Famicom Disk System en Japón, lo que permitió guardar partida, algo muy llamativo para su tiempo.</p>
        </div>

        <h3>Por qué sigue siendo legendario</h3>
        <p>Su legado sigue vivo porque puso las bases de una franquicia gigantesca y de muchas ideas que hoy son normales en juegos de aventura y exploración.</p>
        <p>Zelda no solo fue un clásico: fue una invitación a perderse en una aventura inolvidable.</p>
      ...
      <?php if (isset($_SESSION['user_id'])): ?>
        <form method="POST" action="" class="comment-form">
          <div class="form-group">
            ...
            <textarea id="commentText" name="comment_text" maxlength="500" placeholder="Comparte tu recuerdo sobre Zelda..." required></textarea>
            ...
            <div class="comment-card">
              ...
              <div class="comment-actions">
                <div class="like-section">
                  ...
                  <?php endif; ?>
                  <div class="like-count"><?php echo (int)$comment['total_likes']; ?> like<?php echo ((int)$comment['total_likes'] !== 1) ? 's' : ''; ?></div>
                </div>
              </div>
            </div>
          <?php endforeach; ?>
...
<footer class="site-footer">
  <div class="container"><p>© <span id="year"></span> Retro Vibes - Blog de videojuegos retro</p></div>
</footer>
...
if (commentText && contador) {
  const actualizarContador = () => { contador.textContent = commentText.value.length + ' / 500'; };
